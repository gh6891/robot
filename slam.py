...
if __name__ == "__main__":
    ...
    world.reset()
    first_target_position = np.array([0., 0.4, 0.6])
    ...
    # offset_orientation = np.array([180.0, -90.0, 0.0]) # euler angles
    # offset_orientation = offset_orientation[::-1]
    # offset_orientation_matrix = euler_to_rot_matrix(offset_orientation, degrees = True, extrinsic=True)

    target_orientation_euler = np.array([0, 90, 180]) # euler angles
    # target_orientation_euler = target_orientation_euler[::-1]
    print(f"==>> target_orientation_euler: {target_orientation_euler}")
    

    # target_orientation_maxtix = euler_to_rot_matrix(target_orientation_euler, degrees = True, extrinsic=False)
    
    # target_orientation_matrix = target_orientation_maxtix @ offset_orientation_matrix
    # offset_orientation_matrix_inv = np.linalg.inv(offset_orientation_matrix)
    # target_orientation_matrix = offset_orientation_matrix_inv @ target_orientation_maxtix
