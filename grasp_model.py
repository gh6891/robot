...
day3_dir = "/home/gh6891/바탕화면/isaac_sim/AILAB_summer_school/lecture"
cgent_dir = "/home/gh6891/바탕화면/isaac_sim/AILAB_summer_school/lecture/day3"
sys.path.append(lecture_dir)
sys.path.append(day3_dir)
sys.path.append(cgent_dir)
...
data_path = os.path.join(Path(working_dir).parent, 'dataset/scene_generate_usd/ShapeNetCore_TargetObjects_mat')
...
grasp_model_path = os.path.join(current_path, 'data/checkpoint/contact_grasp_ckpt/ckpt-iter-60000_gc6d.pth')
builder.load_model(grasp_model, grasp_model_path)
grasp_model.to(device)
grasp_model.eval()

# Detection model을 위한 모델 불러오기
detection_model_path = os.path.join(current_path, 'data/checkpoint/faster_r-cnn_ckpt/best_model.pth')
